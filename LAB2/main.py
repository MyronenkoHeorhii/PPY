...
Original file is located at
    https://colab.research.google.com/github/MyronenkoHeorhii/PPY/blob/main/LAB2/main.ipynb
...
try:
    ...
    numbers_tuple.remove(numTuple[0])
except AttributeError:
...
num_integers = sum([1 for line in file_content if line.strip().isdigit()])
#   Add all integers in the file (sum).
integer_sum = sum([int(line.strip()) for line in file_content if line.strip().isdigit()])
